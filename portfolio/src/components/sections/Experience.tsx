  ...
  return (
    ...
    >
      <CardHeader className="pb-3">
        ...
        <CardTitle className="mt-2 text-base font-semibold leading-snug">
          {isWork
            ...
            : (entry as EduEntry).degree}
        </CardTitle>
        <CardDescription>
          {isWork ? (entry as WorkEntry).role : (entry as EduEntry).institution}
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="pt-0">
        ...
        {/* Education: courses */}
        {!isWork && (entry as EduEntry).courses && (entry as EduEntry).courses!.length > 0 && (
          <>
